...
def parse_arguments():
    ...
    parser.add_argument("operation", choices=[
        ...
        "hmp_to_vcf",
        "vcf_to_hmp"
    ], help="The conversion operation to perform ('plink_to_vcf', 'plink_to_hmp', 'vcf_to_plink', 'hmp_to_plink', 'hmp_to_vcf', 'vcf_to_hmp').")
    ...
    if args.operation in ["plink_to_vcf", "plink_to_hmp"]:
    ...
    if args.operation in ["vcf_to_plink", "hmp_to_plink"]:
    ...
    if args.operation in ["plink_to_vcf", "plink_to_hmp", "vcf_to_plink", "vcf_to_hmp", "hmp_to_plink", "hmp_to_vcf"]:
